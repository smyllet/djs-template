...
export class StringCommandOption implements CommandOption {
    ...
    constructor(settings: {name: string | LocaleText[], description: string | LocaleText[], required: boolean, minLength?: number, maxLength?: number, choices?: {name: string | LocaleText[], value: string}[]}) {
